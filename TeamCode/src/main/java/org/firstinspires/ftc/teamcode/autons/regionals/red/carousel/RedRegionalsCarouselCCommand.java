...
public class RedRegionalsCarouselCCommand extends SequentialCommandGroup {
    public RedRegionalsCarouselCCommand(Drivetrain drivetrain, Lift lift, Intake intake, DuckWheels duckWheels, Telemetry telemetry) {
        addCommands(
                //blue mid carousel
                //command sequence
                //duck
                ...
                new SlowDriveForwardCommand(drivetrain, -6.5),//perfect distance
