...
public class BlueRegionalsCarouselLCommand extends SequentialCommandGroup {
    public BlueRegionalsCarouselLCommand(Drivetrain drivetrain, Lift lift, DuckWheels duckWheels, Cap cap, Telemetry telemetry) {
        addCommands(
                //blue mid carousel
                //command sequence
                //duck
